...
from .train_origin import Train
from test import Test
from metric.iou import IoU
from args import get_arguments
from data_loader.utils import enet_weighing, median_freq_balancing
import utils
...
def train(
    ...
    output_file_path = os.path.join(save_dir, 'results.txt')
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        output_file.write("Epoch {0:d} Training: Loss: {1:.4f} | mIoU: {2:.4f}\n".
                        format(epoch, epoch_loss, miou))
        ...
        if (epoch + 1) % 10 == 0 or epoch + 1 == args.epochs:
            ...
            # Write validation results to the text file
            output_file.write("Epoch {0:d} Validation: Loss: {1:.4f} | mIoU: {2:.4f}\n".
                            format(epoch, loss, miou))
